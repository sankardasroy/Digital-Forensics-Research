...
\begin{itemize}
    \item[\textbf{basic:}] Deleted file is contiguous and the only file on the disk
\end{itemize}
...
\begin{itemize}
    \begin{figure}
        ...
        \label{fig:case2}
    \end{figure}
    \item[\textbf{fragments1:}] Deleted file is fragmented around an active file (as illustrated in Figure~\ref{fig:case2})
    \item[\textbf{fragments2:}] Deleted file is fragmented around another deleted file
\end{itemize}
...
\begin{itemize}
    ...
    \begin{figure}[h]
        ...
        \label{fig:case8}
    \end{figure}
    \item[\textbf{overwrite1:}] Deleted file is overwritten at the front by an active file
    \item[\textbf{overwrite2:}] Deleted file is overwritten in the middle by an active file (as illustrated in Figure~\ref{fig:case5})
    \item[\textbf{overwrite3:}] Deleted file is completely overwritten by an active file
    \item[\textbf{overwrite4:}] Deleted file is overwritten at the front by another deleted file (as illustrated in Figure~\ref{fig:case8})
    \item[\textbf{overwrite5:}] Deleted file is overwritten in the middle by another deleted file
    \item[\textbf{overwrite6:}] Deleted file completely overwritten by another deleted file
\end{itemize}
\paragraph{Deleted File is Fragmented and Overwritten}
 \begin{itemize}
     \begin{figure}[h]
        ...
        \label{fig:case12}
    \end{figure}
    \item[\textbf{combo1:}] Deleted file is fragmented around an active file, and the second fragment is overwritten by another active file (as illustrated in Figure~\ref{fig:case12})
    \item[\textbf{combo2:}] Deleted file is fragmented around an active file, and the second fragment is overwritten by another deleted file
 \end{itemize}
...
\begin{itemize}
    \begin{figure}[h]
        ...
        \label{fig:case14}
    \end{figure}
    \item[\textbf{disorder1:}] Deleted file fragmented out-of-order (as illustrated in Figure~\ref{fig:case14})
    \item[\textbf{disorder2:}] Deleted file fragmented out-of-order with an active file in between the fragments
    \item[\textbf{disorder3:}] Deleted file fragmented out-of-order with a deleted file in between the fragments
\end{itemize}
...
When a deleted file is overwitten by another deleted file, even FTK acts as though the overwritten part belongs to the original file.
