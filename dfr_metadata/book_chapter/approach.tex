...
We observed that tools typically use one of two strategies in the event of FAT fragmentation.
...
All tools were able to handle fragmentation in NTFS with no issues.
