...
%         \label{fig:case_2}
%     \end{figure}
    \item Deleted file is fragmented around an active file (as illustrated in Figure~\ref{fig:case_2})
...
%     \end{figure}
    ...
    \item Deleted file is overwritten in the middle by an active file (as illustrated in Figure~\ref{fig:case_4ii})
    ...
    \item Deleted file is overwritten at the front by another deleted file (as illustrated in Figure~\ref{fig:case_5i})
...
%         \label{fig:case_6}
%     \end{figure}
    \item Deleted file is fragmented around an active file, and the second fragment is overwritten by another active file (as illustrated in Figure~\ref{fig:case_6})
...
%         \label{fig:case_8}
%     \end{figure}
    \item Deleted file fragmented out-of-order (as illustrated in Figure~\ref{fig:case_8})
