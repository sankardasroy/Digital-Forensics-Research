...
We first return to the questions posed in Section~\ref{rqs}, to assess the performance of the DFR tools according to the NIST guidelines.
...
\subsubsection{How well do our selected file carving tools meet each of the NIST CFTT guidelines?}
