...
is replaced with an underscore ('\_'). The main change happens in the FAT table where all entries
...
\begin{figure}[h]
    ...
    \caption{The actual data part and metadata of bar.txt are shown after the file is deleted whereas its entries in the FAT table (i.e., entry $200$ to entry $204$) are zeroed.}
    \label{fig:fat2}
\end{figure}
