...
Depending on the working principle, we classify DFR tools into two subtypes: \emph{Metadata-based DFR} tools and \emph{file carving} tools.
...
header and footer signature for the recovery task. In this article, we independently study both \emph{metadata-based DFR} tools and \emph{file carving} tools.      
