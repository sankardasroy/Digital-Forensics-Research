...
For instance, a tool may employ a \emph{strong match policy} to identify a deleted file, which can help the tool avoid retrieving a \emph{bogus file} (i.e., a false positive) 
...
and have room for clarification or improvement. We provide critique on applicability of the NIST CFTT guidelines.
