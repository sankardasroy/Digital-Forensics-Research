...
\usepackage[hyphenbreaks=true]{breakurl}
...
\maketitle
\begin{abstract}
Digital forensics (DF) tools are used for post-mortem investigation of cyber-crimes. 
National Institute of Standards and Technology (NIST) 
has set standards for DF tools. Compliance with the standards by the DF tools is critical to ensure 
correctness of results as well as integrity of judicial proceedings, which increasingly rely on 
trusted analysis of digital artifacts. 
