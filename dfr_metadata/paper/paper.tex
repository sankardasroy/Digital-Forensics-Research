...
\maketitle
\begin{abstract}
Digital forensic (DF) tools are used for post-mortem investigation of cyber-crimes and cyber-attacks. 
...
We compare those tools' performance, and hope that the comparative analysis would help the user choose the right DFR tool. 
