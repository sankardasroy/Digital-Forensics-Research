...
James Lyle from NIST published an article~\cite{LyleICDF2C-2011} in 2012, which lays out a strategy to evaluate the metadata-based DFR tools. To the best of our knowledge, 
