...
In an NTFS system, a file has an entry in the Master File Table (MFT) where each entry is typically 1024 bytes. 
...
the deleted file starts in cluster 100 and has a size of 100 clusters;
