...
To test the DFR tools, we first designed hypothetical test scenarios involving factors which would make recovery difficult. 
...
This case is ideal and trivial, but by adding more files, we can create far more complex scenarios.
...
For Magnet Axiom we performed a ``full scan'' in Axiom Process and exported the resuts from ``filesystem view'' in Axiom Examine.
...
This can be seen in the results\ref{fig:results} for FAT case 2\ref{fig:case_2}. 
