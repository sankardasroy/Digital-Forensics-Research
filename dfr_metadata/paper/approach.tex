...
\end{itemize}
\subsubsection{Fragmented Files}
\begin{itemize}
    \begin{figure}[h]
        \centering
        ...
        \label{fig:case_2}
    \end{figure}
    \item [2] Fragmented deleted file, with an active file in between the fragments (as illustrated in Figure~\ref{fig:case_2})
    \item [3] Fragmented deleted file, with a deleted file in between the fragments
\end{itemize}
\subsubsection{Overwritten Files}
\begin{itemize}
    \begin{figure}[h]
        \centering
    ...
    \item [4ii] Middle of deleted file overwritten by an active file (as illustrated in Figure~\ref{fig:case_4ii})
    ...
    \item [5i] Beginning of deleted file overwritten by another deleted file (as illustrated in Figure~\ref{fig:case_5i})
...
\end{itemize}
\subsubsection{Fragmented and Overwritten Files}
 \begin{itemize}
     \begin{figure}[h]
        \centering
        ...
        \label{fig:case_6}
    \end{figure}
    \item [6] Fragmented deleted file, with an active file in between the fragments, with the second fragment overwritten by another active file (as illustrated in Figure~\ref{fig:case_6})
 ...
 \end{itemize}
\subsubsection{Out-of-Order Fragmentation}
\begin{itemize}
    \begin{figure}[h]
        \centering
        ...
        \label{fig:case_8}
    \end{figure}
    \item [8] Deleted file fragmented from the end of the file system to the beginning (as illustrated in Figure~\ref{fig:case_8})
