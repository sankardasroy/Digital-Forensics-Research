...
In other words, these standards address situations in which files were deleted via normal filesystem operations as implemented by a typical operating system, rather than manual tampering with the files and filesystem.
...
\begin{itemize}
    ...
    \begin{figure}[h]
        ...
        \label{fig:case_10}
    \end{figure}
    \item [10] Deleted file fragmented from the end of the filesystem to after a deleted file (Illustrated in Figure \ref{fig:case_10})
\end{itemize}
